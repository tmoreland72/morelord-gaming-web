CREATE TABLE campaign_relationship_proposals (
 id TEXT NOT NULL,
 campaign_id TEXT NOT NULL REFERENCES campaigns(id) ON DELETE CASCADE,
 from_id TEXT NOT NULL,
 to_id TEXT NOT NULL,
 kind TEXT NOT NULL CHECK(kind IN ('member_of','former_member_of','mentored_by','located_in','takes_place_at','commissioned_by')),
