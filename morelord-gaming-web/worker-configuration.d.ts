/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0daea3fa255035fbb6263eaa38ef1639)
...
interface __BaseEnv_Env {
	...
	STRIPE_PRICE_CHAMPION_MONTHLY: string;
	STRIPE_PRICE_CHAMPION_ANNUAL: string;
	DISCORD_CLIENT_ID: string;
	DISCORD_CLIENT_SECRET: string;
	DISCORD_REDIRECT_URI: string;
	DISCORD_BOT_TOKEN: string;
	DISCORD_GUILD_ID: string;
	DISCORD_ROLE_COMMUNITY: string;
	DISCORD_ROLE_PREMIUM: string;
	DISCORD_ROLE_CHAMPION: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RELEASE_PUBLISH_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_PRICE_PREMIUM_MONTHLY" | "STRIPE_PRICE_PREMIUM_ANNUAL" | "STRIPE_PRICE_CHAMPION_MONTHLY" | "STRIPE_PRICE_CHAMPION_ANNUAL" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "DISCORD_REDIRECT_URI" | "DISCORD_BOT_TOKEN" | "DISCORD_GUILD_ID" | "DISCORD_ROLE_COMMUNITY" | "DISCORD_ROLE_PREMIUM" | "DISCORD_ROLE_CHAMPION" | "DISCORD_INVITE_URL" | "ADMIN_EMAILS">> {}
}
