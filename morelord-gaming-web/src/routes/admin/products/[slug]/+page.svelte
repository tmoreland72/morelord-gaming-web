...
<section class="section brand-panel-section">
	<div class="shell admin-dashboard">
		...
		<form class="card admin-editor" method="POST" action="?/saveProduct" use:enhance>
		...
		{#if data.product}
			<section class="account-section">
				...
				<div class="admin-feature-list">
					{#each data.features as feature}
						<article class="card admin-feature-row">
							...
							<form method="POST" action="?/updateFeature" use:enhance class="feature-tier-form">
							...
							<form method="POST" action="?/removeFeature" use:enhance>
								<input type="hidden" name="featureId" value={feature.id} />
				...
				<form class="card admin-editor" method="POST" action="?/addFeature" use:enhance>
